<%@ Page Title="CD Settlement Fax" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="ss-company-driver-send-to-fax.aspx.vb" Inherits="secure_ss_company_driver_send_to_fax" %>
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2 margin-bottom30">
            ...
            <div class="center-button">
                <a href="ss-company-driver-summary.aspx" class="btn-action-celadon margin-top10 button-margin-bottom20" onclick="ga('send', 'event', 'link', 'navigation', 'cd-back-to-settlement');">Back to Settlement</a>
            </div>
        </div>
    </div>
</asp:Content>
